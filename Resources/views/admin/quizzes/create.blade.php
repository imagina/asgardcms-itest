...
@section('content-header')
    <h1>
        {{ trans('itest::quizzes.title.create quiz') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i
                        class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.itest.quiz.index') }}">{{ trans('itest::quizzes.title.quizzes') }}</a></li>
        <li class="active">{{ trans('itest::quizzes.title.create quiz') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.itest.quiz.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-xs-12 col-md-9">
            <div class="row">
                            ...
                            <div class="tab-content">
                                ...
                                @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                                    ...
                                    <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                                        @include('itest::admin.quizzes.partials.create-fields', ['lang' => $locale])
                                    </div>
                                @endforeach
                ...
                @if (config('asgard.itest.config.fields.quiz.partials.normal.create')&&config('asgard.itest.config.fields.quiz.partials.normal.create') !== [])
                    <div class="col-xs-12 ">
                        <div class="box box-primary">
                            <div class="box-header">
                            </div>
                            <div class="box-body ">
                                @foreach (config('asgard.itest.config.fields.quiz.partials.normal.create') as $partial)
                                    @include($partial)
                                @endforeach
                        ...
                        <div class="box-body ">
                            <div class="box-footer">
                                ...
                                <a class="btn btn-danger pull-right btn-flat"
                                   href="{{ route('admin.itest.quiz.index')}}"><i
