...
@section('content-header')
    <h1>
        {{ trans('itest::results.title.create result') }}
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-9">
            <div class="row">
                            ...
                            <div class="tab-content">
                                ...
                                @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                                    ...
                                    <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                                        @include('itest::admin.results.partials.create-fields', ['lang' => $locale])
                                    </div>
                                @endforeach
                ...
                @if (config('asgard.itest.config.fields.result.partials.normal.create')&&config('asgard.itest.config.fields.result.partials.normal.create') !== [])
                    <div class="col-xs-12 ">
                        <div class="box box-primary">
                            <div class="box-header">
                            </div>
                            <div class="box-body ">
                                @foreach (config('asgard.itest.config.fields.result.partials.normal.create') as $partial)
                                    @include($partial)
                                @endforeach
        ...
        <div class="col-xs-12 col-md-3">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <label>{{trans('itest::results.form.value')}}</label>
                            <div class="box-tools pull-right">
                        ...
                        <div class="box-body ">
                            <div class='form-group{{ $errors->has("value") ? ' has-error' : '' }}'>
                                {!! Form::text("value", old("value"), ['class' => 'form-control', 'placeholder' => trans('itest::results.form.value')]) !!}
